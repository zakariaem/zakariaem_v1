// Generated by Zakariae Mhiriz from file ros_zakariaem/Imu.msg
// DO NOT EDIT!


#ifndef ROS_ZAKARIAEM_MESSAGE_IMU_H
#define ROS_ZAKARIAEM_MESSAGE_IMU_H
...
struct Imu_
{
  ...
  typedef boost::shared_ptr< ::ros_zakariaem::Imu_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ros_zakariaem::Imu_<ContainerAllocator> const> ConstPtr;

}; // struct Imu_

typedef ::ros_zakariaem::Imu_<std::allocator<void> > Imu;

typedef boost::shared_ptr< ::ros_zakariaem::Imu > ImuPtr;
typedef boost::shared_ptr< ::ros_zakariaem::Imu const> ImuConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ros_zakariaem::Imu_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ros_zakariaem::Imu_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ros_zakariaem::Imu_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ros_zakariaem::Imu_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ros_zakariaem::Imu_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ros_zakariaem::Imu_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ros_zakariaem::Imu_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ros_zakariaem::Imu_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ros_zakariaem::Imu_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ros_zakariaem::Imu_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6a62c6daae103f4fULL;
  static const uint64_t static_value2 = 0xf57a132d6f95cec2ULL;
};

template<class ContainerAllocator>
struct DataType< ::ros_zakariaem::Imu_<ContainerAllocator> >
{
  static const char* value()
  {
    return "ros_zakariaem/Imu";
  }
...
template<class ContainerAllocator>
struct Definition< ::ros_zakariaem::Imu_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ros_zakariaem::Imu_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ros_zakariaem::Imu_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ros_zakariaem::Imu_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // ROS_ZAKARIAEM_MESSAGE_IMU_H
